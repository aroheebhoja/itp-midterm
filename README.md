21-321 midterm project: I came up with a variant that increases at every iteration of the Gale Shapley algorithm for stable matching, then formalized the proof. 
